...
double HAOpen5 = iCustom(NULL, 0, "Heiken_Ashi_Smoothed", 2, 4, 2, 1, 2, Current + 0); 
double HAClose5 = iCustom(NULL, 0, "Heiken_Ashi_Smoothed", 2, 4, 2, 1, 3, Current + 0);
...
//====================================Begin Placing Orders================================//
   ...
   if(total<2) 
     ...
     if(TradeSession()==True)
      ...
      if((HAOpen2 > HAClose2 && HAOpen3 < HAClose3) || (HAOpen4 > HAClose4 && HAOpen5 < HAClose5))
        {
         ticket=OrderSend(Symbol(),OP_BUY,Lots,Ask,3,Ask-StopLoss*mPoint,Ask+TakeProfit*mPoint,"LoneWolf",MagicNumber+1,0,Blue);
         if(ticket>0)
           {
         ...
         OrderSelect(cnt, SELECT_BY_POS, MODE_TRADES);
           ...
           {
            // should it be closed?
          //  if (HAOpen4 > HAClose4 && HAOpen5 < HAClose5)// && ArrowUp>ArrowDown && ArrowUp1<ArrowDown1) //&& HAOpen1>HAClose1)
            //  {
      ...
      if((HAOpen2 < HAClose2 && HAOpen3 > HAClose3) || (HAOpen4 < HAClose4 && HAOpen5 > HAClose5))
        {
         ticket=OrderSend(Symbol(),OP_SELL,Lots,Bid,3,Bid+StopLoss*mPoint,Bid-TakeProfit*mPoint,"LoneWolf",MagicNumber+2,0,Red);
         if(ticket>0)
           {
