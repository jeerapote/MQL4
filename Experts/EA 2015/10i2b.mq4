...
if(v4){
   if(AccountEquity()-(v4TakeProfit*Digs) > AccountBalance())KillEverything();
}
...
int result;
     ...
     if(v6)result=OrderSend(Symbol(),OP_BUY,Lots,Ask,10,0,NormalizeDouble(Ask+V6pipsProfit*Point,Digits),"BD "+DoubleToStr(Magix,0),Magix,0,Green); //if(v6)result=OrderSend(Symbol(),OP_BUY,Lots,Ask,10,0,NormalizeDouble(Ask+V6pipsProfit*Point,Digits),"BD "+DoubleToStr(Magix,0),Magix,0,Green);
    // Alert("result: ",result);
     if(result>0){LMag=0;}
...
int result;
     ...
     if(v6)result=OrderSend(Symbol(),OP_SELL,Lots,Bid,10,0,NormalizeDouble(Bid-V6pipsProfit*Point,Digits),"BD "+DoubleToStr(Magix,0),Magix,0,Red); //if(v6)result=OrderSend(Symbol(),OP_SELL,Lots,Bid,10,0,NormalizeDouble(Bid-V6pipsProfit*Point,Digits),"BD "+DoubleToStr(Magix,0),Magix,0,Green);
