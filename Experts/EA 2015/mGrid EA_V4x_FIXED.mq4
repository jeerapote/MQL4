...
extern double              ORDER_FREQ              = 0.5;  

extern double              stoploss_                = 250;
extern double              increment_               = 8;
extern double              retracement_             = 15;
extern double              range_                   = 20;
extern double              difference_              = 15; 
...
double RETRACEMENT    = retracement_*10;
double RANGE          = range_*10;
double DIFFERENCE     = difference_*10;
   ...
   if(EnableBolinAndWpr){
      ...
      if(wpr > -30 && BolingerMidBand <= Bid)CloseGrid();    
       ...
       if(key || key2 || key3 ){
          ...
          if(lastAskPrice > Ask+INCREMENT*ORDER_FREQ*Point || lastBidPrice < Bid -INCREMENT*ORDER_FREQ*Point)Retracement();
