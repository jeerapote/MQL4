...
//---------------------------------------------------------------------------- 3 --
   while(Mas_Tip[Tip]<=MaxOrders)                // Until they ..
     {               
     
     Inform(10,StopLoss);                    //.. succeed
      ...
      if (Tip==0)                        // Let's open a Buy
       ...
       //  if(MaxOrders==3)SL=Last_Stoploss;
         if(MaxOrders==3)TP=Last_TakeProfit;
      ...
      // if(MaxOrders==0)Last_Stoploss = SL;
       if(MaxOrders==0)Last_TakeProfit = TP;
      //---------------------------------------------------------------------- 4 --
      if (Ticket<0)                       // Failed :( 
        {                                 // Check for errors:
